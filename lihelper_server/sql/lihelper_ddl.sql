...
CREATE TABLE `alarm_mode` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '@desc 主键ID',
  `name` varchar(50) NOT NULL COMMENT '@desc 报警方式，email/phone/message',
  `alarm_id` varchar(50) NOT NULL COMMENT '@desc alarm表主键',
  `gmt_create` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `gmt_modify` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `alarm_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '@desc 主键ID',
  `alarm_id` int(10) NOT NULL COMMENT '@desc monitor_alarm表中的id关联',
